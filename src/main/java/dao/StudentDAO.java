...
public class StudentDAO {
    ...
    private static final String DB_PASSWORD = "minhquantqd";
    ...
    public List<Student> searchStudents(String keyword) {
        List<Student> students = new ArrayList<>();
        String sql = "SELECT * FROM students WHERE full_name LIKE ? OR student_code LIKE ? OR email LIKE ? " + "ORDER BY id DESC";
